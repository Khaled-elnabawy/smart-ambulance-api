...
class Loading<T> implements EditProfileState<T> {
  const Loading();
...
class Success<T> implements EditProfileState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $EditProfileStateCopyWith<T, $Res> {
...
class Failure<T> implements EditProfileState<T> {
...
@override
String toString() {
  return 'EditProfileState<$T>.failure(errMessage: $errMessage)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $EditProfileStateCopyWith<T, $Res> {
