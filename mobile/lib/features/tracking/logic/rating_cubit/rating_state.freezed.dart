...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RatingState<T>);
}
...
/// @nodoc
class $RatingStateCopyWith<T,$Res>  {
$RatingStateCopyWith(RatingState<T> _, $Res Function(RatingState<T>) __);
}


/// Adds pattern-matching-related methods to [RatingState].
extension RatingStatePatterns<T> on RatingState<T> {
...
class _Initial<T> implements RatingState<T> {
  const _Initial();
...
class Loading<T> implements RatingState<T> {
  const Loading();
...
class Success<T> implements RatingState<T> {
...
@override
String toString() {
  return 'RatingState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $RatingStateCopyWith<T, $Res> {
...
class Failure<T> implements RatingState<T> {
...
@override
String toString() {
  return 'RatingState<$T>.failure(errMessage: $errMessage)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $RatingStateCopyWith<T, $Res> {
