...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RejectState<T>);
}
...
/// @nodoc
class $RejectStateCopyWith<T,$Res>  {
$RejectStateCopyWith(RejectState<T> _, $Res Function(RejectState<T>) __);
}


/// Adds pattern-matching-related methods to [RejectState].
extension RejectStatePatterns<T> on RejectState<T> {
...
class _Initial<T> implements RejectState<T> {
  const _Initial();
...
class Loading<T> implements RejectState<T> {
  const Loading();
...
class Success<T> implements RejectState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of RejectState
...
@override
String toString() {
  return 'RejectState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $RejectStateCopyWith<T, $Res> {
...
class Failure<T> implements RejectState<T> {
...
@override
String toString() {
  return 'RejectState<$T>.failure(errMessage: $errMessage)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $RejectStateCopyWith<T, $Res> {
