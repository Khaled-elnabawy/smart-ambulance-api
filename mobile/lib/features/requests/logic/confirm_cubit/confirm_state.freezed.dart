...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ConfirmState<T>);
}
...
/// @nodoc
class $ConfirmStateCopyWith<T,$Res>  {
$ConfirmStateCopyWith(ConfirmState<T> _, $Res Function(ConfirmState<T>) __);
}


/// Adds pattern-matching-related methods to [ConfirmState].
extension ConfirmStatePatterns<T> on ConfirmState<T> {
...
class _Initial<T> implements ConfirmState<T> {
  const _Initial();
...
class Loading<T> implements ConfirmState<T> {
  const Loading();
...
class Success<T> implements ConfirmState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of ConfirmState
...
@override
String toString() {
  return 'ConfirmState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ConfirmStateCopyWith<T, $Res> {
...
class Failure<T> implements ConfirmState<T> {
...
@override
String toString() {
  return 'ConfirmState<$T>.failure(errMessage: $errMessage)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $ConfirmStateCopyWith<T, $Res> {
