...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CancelState<T>);
}
...
/// @nodoc
class $CancelStateCopyWith<T,$Res>  {
$CancelStateCopyWith(CancelState<T> _, $Res Function(CancelState<T>) __);
}


/// Adds pattern-matching-related methods to [CancelState].
extension CancelStatePatterns<T> on CancelState<T> {
...
class _Initial<T> implements CancelState<T> {
  const _Initial();
...
class Loading<T> implements CancelState<T> {
  const Loading();
...
class Success<T> implements CancelState<T> {
...
@override
String toString() {
  return 'CancelState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CancelStateCopyWith<T, $Res> {
...
class Failure<T> implements CancelState<T> {
...
@override
String toString() {
  return 'CancelState<$T>.failure(errMessage: $errMessage)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $CancelStateCopyWith<T, $Res> {
